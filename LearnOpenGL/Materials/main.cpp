...
// lighting
glm::vec3 lightPos(0.f, 1.0f, 2.0f);
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightingShader.use();
		lightPos.x = lightPos.x + sin(glfwGetTime());
		//lightPos.y += sin(glfwGetTime()) * 0.1;
		//lightPos.z += sin(glfwGetTime()) * 0.1;

		lightingShader.setVec3("light.position", lightPos);
		lightingShader.setVec3("viewPos", camera.Position);

		glm::vec3 lightColor = glm::vec3(0.2f, 0.5f, 0.3f);
